    ...
    if disco_enabled and disco_scale > 0:
        try:
            ...
            disco_settings = {
                ...
                'disco_transforms': disco_transforms or ['spherical', 'color_shift'],
            ...
            disco_integration.activate_for_generation(final_unet)
