...
def sample_hacked(model, noise, positive, negative, cfg, device, sampler, sigmas, model_options={}, latent_image=None, denoise_mask=None, callback=None, disable_pbar=False, seed=None):
    ...
    if sampler in sampler_dispatch:
        ...
        samples = selected_sampler_func(model_wrap, x=noise, sigmas=sigmas, extra_args=extra_args, callback=callback_wrap, disable=disable_pbar)
    else:
        ...
        samples = k_diffusion_sampling.sample_euler(model_wrap, x=noise, sigmas=sigmas, extra_args=extra_args, callback=callback_wrap, disable=disable_pbar)
