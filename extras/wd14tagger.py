...
def default_interrogator(image_rgb, threshold=0.35, character_threshold=0.85, exclude_tags=""):
    ...
    model_name = "wd-vit-large-tagger-v3"

    model_onnx_filename = load_file_from_url(
        url=f'https://huggingface.co/SmilingWolf/wd-vit-large-tagger-v3/resolve/main/model.onnx',
        model_dir=path_clip_vision,
        file_name=f'{model_name}.onnx',
    )

    model_csv_filename = load_file_from_url(
        url=f'https://huggingface.co/SmilingWolf/wd-vit-large-tagger-v3/resolve/main/selected_tags.csv',
        model_dir=path_clip_vision,
